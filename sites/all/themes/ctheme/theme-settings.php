 ...
 *   The form state.
 */
function ctheme_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['mtt_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('cTheme Settings'),
    '#collapsible' => FALSE,
	'#collapsed' => FALSE,
  );
  ...
  $form['mtt_settings']['breadcrumb']['breadcrumb_display'] = array(
	...
	'#default_value' => theme_get_setting('breadcrumb_display','ctheme'),
    '#collapsible' => TRUE,
	'#collapsed' => FALSE,
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_display'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_display','ctheme'),
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_effect'] = array(
    ...
    '#title' => t('Effects'),
	  ...
	  '#default_value' => theme_get_setting('slideshow_effect','ctheme'),
    '#options' => array(
		'blindX' => t('blindX'),
		'blindY' => t('blindY'),
		'blindZ' => t('blindZ'),
  ...
  $form['mtt_settings']['slideshow']['slideshow_effect_time'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_effect_time','ctheme'),
  );
}
